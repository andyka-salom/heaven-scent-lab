...
<body class="h-full font-sans antialiased" x-data="{ sidebarOpen: false }">
    <div class="min-h-full flex">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            {{-- Top Navbar --}}
            <header class="sticky top-0 z-30 h-16 bg-white/90 backdrop-blur-md border-b border-gray-200/80 shadow-sm flex items-center justify-between px-4 lg:px-8 transition-all">
